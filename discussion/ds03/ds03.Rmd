...
What type of ship is most prone to damage incidents?
...
```{r}
ships %>%
  ggplot(aes(x = type, y = incidents)) +
  geom_col(aes(fill = type)) +
  labs(title = "Damage incidents by ship type", subtitle = "What type of ship is most prone to damage incidents?", x = "Ship Type", y = "Damage Incidents", caption = "data from 1960-1979")
```
...
Our other group had a very similar research question, and drew the same conclusions we did.
I liked how they included the years range of data. They can
