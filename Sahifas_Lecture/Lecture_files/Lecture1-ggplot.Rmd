...
mendota_mode = find_mode(mendota$duration)
...
```{r}
ggplot(mendota, aes(x = duration, color = century, fill = century, linetype = century)) +
...
ggplot(data = mendota_summarized, mapping = aes(x = century, y = avgDuration, color = century)) +
  geom_bar(stat = "identity") +
  geom_text(aes(label=avgDuration), vjust=-0.3, size=3.5)
```
